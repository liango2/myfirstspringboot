...
public class SSHClient_justSoSo {
...
//    private static String[] linuxPromptRegEx = new String[]{"$", "\\>", "#", "~#"};
    private static String[] linuxPromptRegEx = new String[]{"(docker|root)@\\w+:.*[$#]"};
     ...
     * @param password
     */
    public SSHClient_justSoSo(String host, String userName, String password) {
        this.host = host;
    ...
    public static void main(String[] args) {
        SSHClient_justSoSo ssh = new SSHClient_justSoSo("192.168.99.100", "docker", "tcuser");
        List<String> cmdsToExecute = new ArrayList<String>();
//        cmdsToExecute.add("ls");
        cmdsToExecute.add("pwd");
        cmdsToExecute.add("cd /home;pwd");
        cmdsToExecute.add("docker run -it  ubuntu-emacs-man /bin/bash");
        cmdsToExecute.add("pwd");
//        cmdsToExecute.add("emacs");
